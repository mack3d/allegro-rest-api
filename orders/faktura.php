...
$companyname = NULL;$companytaxid = NULL;$naturalperson = NULL;
if(!is_null($invoice->address->company)){$companyname = $invoice->address->company->name;$companytaxid = $invoice->address->company->taxId;}
if(!is_null($invoice->address->naturalPerson)){$naturalperson = $invoice->address->naturalPerson->firstName.' '.$invoice->address->naturalPerson->lastName;}
