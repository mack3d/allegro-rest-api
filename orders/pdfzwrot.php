...
$returns = $allegro->orderBeta("GET", "/customer-returns?orderId={$fod}");
...
foreach ($returns->customerReturns as $customerReturns) {
    $returnsInfo = new Returns($customerReturns->parcels);
