...
}catch(PDOException $e){echo ('Odswiez pobieranie fod-a '.$e->getMessage());}
...
}catch(PDOException $e){bladdodziennika('odswiez delivery '.$e->getMessage());}
...
}catch(PDOException $e){echo ('odswiez '.$e->getMessage());}
