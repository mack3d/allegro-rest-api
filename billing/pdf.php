...
$tw = '<table><tr style="font-weight:bold; font-size:10;"><td width="90" height="25">Transakcja</td><td width="80">Dokument</td><td width="150">Wpłacający</td><td width="90">Login</td><td width="65">Za towar</td><td width="70">Transport</td><td width="65">Razem</td><td width="80">Data</td></tr>';
$tz = '<table>';
function cmpw($a, $b)
{
